...
public class BookDetailPresenter extends BaseRxPresenter<BookDetailContract.View> implements BookDetailContract.Presenter {
    ...
    @Override
    public void openRead(Context context, Integer sectionIndex, String sectionId) {
        AppRouter.showReadActivity(context, book, sectionIndex, sectionId);
    }
            ...
            protected void convert(CommonViewHolder helper, final BookSectionItem item) {
                ...
                helper.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        openRead(v.getContext(), item.getSectionIndex(), item.getSectionId());
                    }
                });
            }
        };
