...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private int pageSelected; //Save the selected index
	...
	public PagerSlidingTabStrip(Context context, AttributeSet attrs,
		...
		indicatorWrapContent = a.getBoolean(
				R.styleable.PagerSlidingTabStrip_pstsIndicatorWrap,
				indicatorWrapContent);
		wrapAddWidth = a.getDimensionPixelOffset(
				R.styleable.PagerSlidingTabStrip_pstsIndicatorWrapAddWidht,
				wrapAddWidth);
		tabTextSize = a.getDimensionPixelSize(
				R.styleable.PagerSlidingTabStrip_pstsTextSize, tabTextSize);
		tabSelectTextColor = a.getColor(
				R.styleable.PagerSlidingTabStrip_pstsSelectedTextColor,
				tabSelectTextColor);
		tabUnSelectTextColor = a.getColor(
				R.styleable.PagerSlidingTabStrip_pstsTextColor,
				tabUnSelectTextColor);
		a.recycle();
	...
	private class PageListener implements OnPageChangeListener {
		...
		public void onPageSelected(int position) {
			...
			.setTextColor(tabSelectTextColor);
			((TextView) tabsContainer.getChildAt(pageSelected))
			.setTextColor(tabUnSelectTextColor);
